...
/* ============== Start Auto-Play Tracking =========================*/
    if(readCookie("userAutoPlay")){
        stribuserAutoPlay = readCookie("userAutoPlay");
        if(stribuserAutoPlay == null){
            stribuserAutoPlay = "Autoplay ON";
        }
        s.prop63=stribuserAutoPlay;
    }else{
        s.prop63="Autoplay ON";
    }
/* ============== End Auto-Play Tracking =========================*/
...
function s_doPlugins(s) {
    ...
    s.eVar12=s.getPreviousValue(s.pageName,'omniture_pn');
    s.eVar13=s.getPreviousValue(s.pageName,'omniture_pn');
    ...
    s.eVar14=s.getPreviousValue(s.channel,'omniture_ch');
    s.eVar15=s.getPreviousValue(s.channel,'omniture_ch');
    s.prop49=s.getPreviousValue(s.prop7,'omniture_p7');
    s.eVar16=s.getPreviousValue(s.prop7,'omniture_p7');
    s.eVar17=s.getPreviousValue(s.prop7,'omniture_p7');
