# Star Tribune - Minnesota Poll 2018: Russian collusion survey
...
1. Get code and enter project: `git clone https://github.com/striblab/20180115-mnpoll-russia.git && cd 20180115-mnpoll-russia.git`
...
2. Copy files (update path as needed): `mkdir -p ../20180115-mnpoll-russia/ && rsync -rav ./ ../20180115-mnpoll-russia/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
